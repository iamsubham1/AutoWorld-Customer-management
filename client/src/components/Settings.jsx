        ...
        <div className='mt-10 flex flex-col items-center justify-center min-h-[50vh]'>
            <nav className='flex justify-center mb-4'>
                <ul className='flex space-x-4'>
                    <li
                        className={`px-4 py-2 cursor-pointer font-medium ${currentView === 'personal-settings' ? 'text-yellow-400' : 'text-white hover:text-[#7a7a7a]'}`}
                        onClick={() => setCurrentView('personal-settings')}
                    >
                        Personal Settings
                    </li>
                    <li
                        className={`px-4 py-2 cursor-pointer  font-medium ${currentView === 'account-management' ? 'text-yellow-400' : 'text-white hover:text-[#7a7a7a]'}`}
